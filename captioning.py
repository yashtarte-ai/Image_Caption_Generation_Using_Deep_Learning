...
word_to_index = {}
with open ("D:\\Projects\\image_Captioning\\models\\word_to_idx.pkl", 'rb') as file:
    word_to_index = pd.read_pickle(file, compression=None)

index_to_word = {}
with open ("D:\\Projects\\image_Captioning\\models\\idx_to_word.pkl", 'rb') as file:
    index_to_word = pd.read_pickle(file, compression=None)



print("Loading the model...")
model = load_model("D:\\Projects\\image_Captioning\\models\\model_14.h5")
...
def runModel(img_name):
    #img_name = ("C:\\Users\\91976\\Downloads\\bickracing.jpg")
...
#runModel("C:\\Users\\91976\\Downloads\\groupofpeopleincycle.jpg")